...
hobbies.get('/:name', async (req, res) => {
    try {
...
// UPDATE A HOBBY
hobbies.put('/:name', async (req, res) => {
    try {
...
// DELETE A HOBBY
hobbies.delete('/:name', async (req, res) => {
    try {
...
hobbies.get('/category/:category', async (req, res) => {
    try {
