...
export default function CreateEvent() {
    ...
    const [eventHobby, setEventHobby] = useState(null);
    ...
    const postData = () => {
        fetch(`${process.env.REACT_APP_SERVER_URL}/events`, options)
            ...
            <form className="mx-10" id="new-event-form">
                <ul className="bg-white dark:bg-slate-900 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl">
                    <li className="py-2 pl-2 border border-slate-300">
                        <label className="text-white" htmlFor="event-name">Event Name: </label>
                        <input
                        type="text"
                        id="event-name"
                        name="event-name"
                    ...
                    <li className="py-2 pl-2 border border-slate-300">
                        <label className="text-white align-top" htmlFor="event-desc">Event Description: </label>
                    ...
                    <li className="py-2 pl-2 border border-slate-300">
                        <label className="text-white" htmlFor="event-hobby">Related Hobby: </label>
                        <input
                    ...
                    <li className="py-2 pl-2 border border-slate-300">
                        <label className="text-white" htmlFor="event-location">Meet-Up Location: </label>
                        <input
