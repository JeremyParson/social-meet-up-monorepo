...
export default function CreateHobby() {
    ...
    const [hobbyImgUrl, setHobbyImgUrl] = useState(null)
    ...
    const postData = () => {
        fetch(`${process.env.REACT_APP_SERVER_URL}/hobbies`, options)
            ...
            <form className="mx-10" id="new-hobby-form">
                <ul className="bg-white dark:bg-slate-900 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl">
                    <li className="py-2 pl-2 border border-slate-300">
                        <label className="text-white" htmlFor="hobby-name">Hobby Name: </label>
                        <input
                    ...
                    <li className="py-2 pl-2 border border-slate-300">
                        <label className="text-white" htmlFor="hobby-category">Hobby Category: </label>
                        <input
                        className="border-2 rounded-lg border-stone-300"
                    ...
                    <li className="py-2 pl-2 border border-slate-300">
                        <label className="text-white" htmlFor="hobby-img-url">Hobby Image URL: </label>
                        <input
